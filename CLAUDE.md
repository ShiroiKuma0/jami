...
- **Upstream tracking: `git`** — the fork versionName pins the upstream base:
  `<upstream>+<base commit date>.<HH-MM>.g<8-char sha>+<BUILD_NUMBER, 3 digits>`, e.g.
  `20260807-01+2026-08-07.20-26.g46f48193+009`. The `HH-MM` and the `+` grouping arrived
  2026-08-12; this repo was already rendering the timestamp in UTC. See the global
  **`git-versioning`** skill. Switched from
