...
class HomeActivity : AppCompatActivity(), ContactPickerFragment.OnContactedPicked {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBinding = ActivityHomeBinding.inflate(layoutInflater).also { binding ->
            ...
            binding.panel.addPanelListener(object : TwoPaneLayout.PanelListener {
                ...
                override fun onSlideableStateChanged(isSlideable: Boolean) {
                    if (!isSlideable) {
                        loadHomeFragmentIfMissing()
                    }
                }
    ...
    companion object {
        ...
        val shareIntentSanitizer = IntentSanitizer.Builder()
            ...
            .allowComponent(ComponentName(BuildConfig.APPLICATION_ID, HomeActivity::class.java.name))
            .allowComponent(ComponentName(BuildConfig.APPLICATION_ID, ShareActivity::class.java.name))
            .allowData { true }
            .allowType { true }
            .allowClipDataText()
